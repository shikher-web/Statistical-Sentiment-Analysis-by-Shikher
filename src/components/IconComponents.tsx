...
export const TableCellsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125V6.375m1.125 13.125A1.125 1.125 0 004.5 18.375h15A1.125 1.125 0 0020.625 19.5m-17.25 0h17.25m-17.25 0H3.375m0 0V6.375m17.25 13.125V6.375m0 0a1.125 1.125 0 00-1.125-1.125H4.5A1.125 1.125 0 003.375 6.375m17.25 0h-1.125" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 6.375v-1.125A1.125 1.125 0 014.5 4.125h15A1.125 1.125 0 0120.625 5.25v1.125" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5v-15m0 0V4.125M10.5 4.125h3M10.5 19.5h3" />
    </svg>
);
